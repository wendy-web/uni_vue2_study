...
// 获取点巡检记录列表API - 无校验登录列表
export function getScanRecordListApi(data) {
	return http.request({
		url: "/mro/Scan/pointCheckList",
		method: "post",
		data,
	});
}
...
// 点巡检记录-无权限详情
export function getScanInspecRecordDetailApi(data) {
	return http.request({
		url: "/mro/Scan/pointCheckDetails",
		method: "post",
		data,
	});
}
