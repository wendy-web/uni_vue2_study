<template>
	<view class="uni-navbar" :class="{ 'uni-dark': dark, 'uni-nvue-fixed': fixed }">
		...
		<view
			...
			:style="{ background: themeBgColor, 'border-bottom-color': themeColor }"
		>
				...
				<view class="uni-navbar__header-container" @tap="onClickTitle">
					<slot>
						<view class="uni-navbar__header-container-inner" v-if="title.length > 0">
							<text class="uni-nav-bar-text uni-ellipsis-1" :style="[{ color: themeColor }, $uv.addStyle(titleStyle)]">{{ title }}</text>
						</view>
					</slot>
				</view>
