...
class Calendar {
    ...
    getCurrentDate(currentDate = new Date(), formatStyle = 'YYYY-MM-DD') {
        ...
        function formatDate(date) {
            ...
            return formatStyle.replace('YYYY', yearPart).replace('MM', monthPart).replace('DD', dayPart);
        }

        return {
            monthStart: formatDate(startOfMonth),
            monthEnd: formatDate(endOfMonth),
