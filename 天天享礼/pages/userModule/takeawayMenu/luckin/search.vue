...
export default {
    ...
    computed: {
        ...
        // isShowSearchResult() {
        //     if(!this.searListItem.length || !this.inputValue) {
        //         return false;
        //     }
        //     return true;
        // }
    ...
    methods: {
        ...
        selComHandle(item) {
            ...
            this.$refs.commodityDetails.popupShow({ product_id });
        },
        goLuckin() {
            this.$reLaunch(`/pages/userModule/takeawayMenu/luckin/index?searchCartNum=${this.cartNum}`);
        },
