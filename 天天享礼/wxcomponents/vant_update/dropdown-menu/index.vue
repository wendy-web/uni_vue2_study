<template>
<uni-shadow-root class="vant_update-dropdown-menu-index"><view class="van-dropdown-menu van-dropdown-menu--top-bottom custom-class">
...
global['__wxRoute'] = 'vant_update/dropdown-menu/index'
...
export default global['__wxComponents']['vant_update/dropdown-menu/index']
</script>
