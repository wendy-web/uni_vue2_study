<template>
<uni-shadow-root class="vant_update-submit-bar-index"><view class="van-submit-bar custom-class">
  <slot name="top"></slot>
...
global['__wxRoute'] = 'vant_update/submit-bar/index'
...
export default global['__wxComponents']['vant_update/submit-bar/index']
</script>
