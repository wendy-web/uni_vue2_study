<template>
<uni-shadow-root class="vant_update-share-sheet-options"><view :class="utils.bem('share-sheet__options', { border: showBorder })">
...
global['__wxRoute'] = 'vant_update/share-sheet/options'
...
export default global['__wxComponents']['vant_update/share-sheet/options']
</script>
