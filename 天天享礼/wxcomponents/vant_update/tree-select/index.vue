<template>
<uni-shadow-root class="vant_update-tree-select-index"><view class="van-tree-select" :style="'height: '+(utils.addUnit(height))">
...
global['__wxRoute'] = 'vant_update/tree-select/index'
...
export default global['__wxComponents']['vant_update/tree-select/index']
</script>
