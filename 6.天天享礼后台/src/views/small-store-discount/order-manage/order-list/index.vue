<template>
  <CommonPage title="订单管理">
    <div class="statistics" ml-10 mt-10 mb-24 flex color-black>
      ...
      <!-- <n-button mr-10 v-has="'export'"> 关闭 </n-button> -->
    </div>
    <CrudTable
      ref="$table"
    ...
    >
      <template #queryBar>
        ...
        <QueryBarItem label="收货人" :label-width="80">
          <n-input v-model:value="queryItems.cz_number" type="text" @keydown.enter="$table?.handleSearch" />
        </QueryBarItem>
...
const columns = ref([
  ...
  { title: '收货人', key: 'cz_number', align: 'center' },
