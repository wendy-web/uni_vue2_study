		...
		columns.value.push({
			...
			render(row, index) {
				return row.lx_type == 1
					? Number(row.price / 100).toFixed(2)
					: row.face_value
			},
		})
		if (newValue == 1) {
