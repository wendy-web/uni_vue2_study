		...
		<view class="inputnum-wrapper">
			<view class="goods-item">
				<view class="item-name">
					<text class="goods-name">TYPE-C公转Lightning公 镀镍ABS外TYPE-C公转Lightning公</text>
				</view>
				<view class="item-barcode">
					<text>条码：6921734969071</text>
				</view>
				...
				<view class="item-btn">
					...
					<view>
						<uv-button text="确认已盘" type="primary" :customStyle="btnStyle" @click="confirm"></uv-button>
					</view>
				</view>
			</view>
		</view>
