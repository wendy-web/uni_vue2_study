				...
				>
					...
					>
						...
						<view class="display_row_center">
							...
							<uv-tags text="未开始" type="info" plain v-if="item.status == 0"></uv-tags>
							<uv-tags text="待检查" type="warning" plain v-else-if="item.status == 1"></uv-tags>
							<uv-tags text="检查中" type="success" plain v-else-if="item.status == 2"></uv-tags>
							<uv-tags text="待审核" type="primary" plain v-else-if="item.status == 3"></uv-tags>
							<uv-tags text="停用" type="error" plain v-else-if="item.status == 4"></uv-tags>
