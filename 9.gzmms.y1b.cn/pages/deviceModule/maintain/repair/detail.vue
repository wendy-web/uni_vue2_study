...
<script>
import { getEqBaseSelect, getRepairDetailApi, repairOrderApi } from "@/api/device/maintain/repair.js";
...
export default {
	...
	methods: {
		async initGetEqBaseSelect() {
			const res = await getEqBaseSelect();
			const { product_line } = res.data;
			this.productOptions = product_line;
		},
