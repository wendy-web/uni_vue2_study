...
const props = withDefaults(defineProps<Props>(), {
  ...
  title: "",
  rowList: () => ["barcode", "title", "spec", "batch_number","ws_code","in_wh_date"],
  pageType: 1, // 1是新建2是编辑
});
...
function checkDetailUnique(list: any[]) {
  console.log("checkDetailUnique执行了");
