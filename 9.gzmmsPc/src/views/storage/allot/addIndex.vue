...
export default {
  beforeRouteEnter(to, from, next) {
    let permsRes = perms(["sto:allot:add", "sto:allot:edit"]);
    if (permsRes) {
      next((vm) => {});
    } else {
...
const state = reactive({
  ...
  preTableData: {} as IAllotAddInfo, //传递给pre页面的数据
...
// 监听add页面的事件
const handleAddChange = (query: IAddEmit<IAllotAddInfo>) => {
