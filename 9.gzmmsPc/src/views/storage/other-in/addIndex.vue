...
import type { IOtherInAddInfo } from "@/api/storage/other-in/types";
...
const state = reactive({
  ...
  preTableData: {} as IOtherInAddInfo, //传递给pre页面的数据
  listId: 0, //id 传给add编辑页
...
// 监听add页面的事件
const handleAddChange = (query: IAddEmit<IOtherInAddInfo>) => {
...
<template>
  <transition name="fade-transform" mode="out-in">
    <KeepAlive :include="['StoOtherInAdd']">
      <component
        :is="comName"
