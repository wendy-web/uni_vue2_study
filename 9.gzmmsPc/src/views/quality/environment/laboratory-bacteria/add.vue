...
function handleCancel() {
  router.replace({
    path: "/quality/environment/laboratory-bacteria",
  });
}
// 点击保存：1-保存，2-提交
...
async function getDetailData() {
  try {
    ...
    formData.value.workshop = Number(res.workshop) || res.workshop;
...
<template>
  <div class="app-container !pb-[40px]">
    <AffixButton v-bind="affixBtnData" :order-type="41" v-on="affixBtnEvent"></AffixButton>
      ...
      <el-tab-pane label="详情信息" name="first">
        ...
        >
          ...
          <el-collapse-item name="2" class="mt-2">
            ...
            <div class="ml-8 mt-4 pl-2 flex align-center" >
              <div>空气洁净度检测示意图:</div>
              <div class="ml-10 flex align-center">
                <el-image
                  class="w-[200px] h-[200px]"
                  :src="imgExample.laboratory_air_bacteria_img"
                  :preview-src-list="[useSetting.baseHttp + imgExample.laboratory_air_bacteria_img]"
                  v-if="imgExample"
                ></el-image>
