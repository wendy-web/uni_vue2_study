          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <el-form-item
                    :prop="`room5_colony_count_val`"
                    :rules="checkFormRules.room5_colony_count_val"
                  >
                    <el-input v-model="checkTableData.room5_colony_count_val" />
                  </el-form-item>
                </td>
                <td>
                  <el-form-item
                    :prop="`room6_colony_count_val`"
                    :rules="checkFormRules.room6_colony_count_val"
                  >
                    <el-input v-model="checkTableData.room6_colony_count_val" />
                  </el-form-item>
                </td>
                <td>
                  <el-form-item
                    :prop="`room7_colony_count_val`"
                    :rules="checkFormRules.room7_colony_count_val"
                  >
                    <el-input v-model="checkTableData.room7_colony_count_val" />
                  </el-form-item>
                </td>
              </tr>
              <!-- 平均菌落数 -->
              <tr>
                ...
                <td>
                  <el-form-item
                    :prop="`room5_avg_colony_count_val`"
                    :rules="checkFormRules.room5_avg_colony_count_val"
                  >
                    <el-input v-model="checkTableData.room5_avg_colony_count_val" />
                  </el-form-item>
                </td>
                <td colspan="2">
                  <el-form-item
                    :prop="`room6_avg_colony_count_val`"
                    :rules="checkFormRules.room6_avg_colony_count_val"
                  >
                    <el-input v-model="checkTableData.room6_avg_colony_count_val" />
                  </el-form-item>
                </td>
              </tr>
              <!-- 平均浓度 -->
              <tr>
                ...
                <td>
                  <el-form-item
                    :prop="`room5_avg_density_val`"
                    :rules="checkFormRules.room5_avg_density_val"
                  >
                    <el-input v-model="checkTableData.room5_avg_density_val" />
                  </el-form-item>
                </td>
                <td colspan="2">
                  <el-form-item
                    :prop="`room6_avg_density_val`"
                    :rules="checkFormRules.room6_avg_density_val"
                  >
                    <el-input v-model="checkTableData.room6_avg_density_val" />
                  </el-form-item>
                </td>
              </tr>
              <!-- 温度 -->
              <tr>
                ...
                <td colspan="2">
                  <el-form-item
                    :prop="`room1_temperature_val`"
                    :rules="checkFormRules.room1_temperature_val"
                  >
                    <el-input v-model="checkTableData.room1_temperature_val" />
                  </el-form-item>
                </td>
                <td colspan="2">
                  <el-form-item
                    :prop="`room3_temperature_val`"
                    :rules="checkFormRules.room3_temperature_val"
                  >
                    <el-input v-model="checkTableData.room3_temperature_val" />
                  </el-form-item>
                </td>
                <td>
                  <el-form-item
                    :prop="`room5_temperature_val`"
                    :rules="checkFormRules.room5_temperature_val"
                  >
                    <el-input v-model="checkTableData.room5_temperature_val" />
                  </el-form-item>
                </td>
                <td colspan="2">
                  <el-form-item
                    :prop="`room6_temperature_val`"
                    :rules="checkFormRules.room6_temperature_val"
                  >
                    <el-input v-model="checkTableData.room6_temperature_val" />
                  </el-form-item>
                </td>
              </tr>
              <!-- 湿度 -->
              <tr>
                ...
                <td colspan="2">
                  <el-form-item
                    :prop="`room1_humidity_val`"
                    :rules="checkFormRules.room1_humidity_val"
                  >
                    <el-input v-model="checkTableData.room1_humidity_val" />
                  </el-form-item>
                </td>
                <td colspan="2">
                  <el-form-item
                    :prop="`room3_humidity_val`"
                    :rules="checkFormRules.room3_humidity_val"
                  >
                    <el-input v-model="checkTableData.room3_humidity_val" />
                  </el-form-item>
                </td>
                <td>
                  <el-form-item
                    :prop="`room5_humidity_val`"
                    :rules="checkFormRules.room5_humidity_val"
                  >
                    <el-input v-model="checkTableData.room5_humidity_val" />
                  </el-form-item>
                </td>
                <td colspan="2">
                  <el-form-item
                    :prop="`room6_humidity_val`"
                    :rules="checkFormRules.room6_humidity_val"
                  >
                    <el-input v-model="checkTableData.room6_humidity_val" />
                  </el-form-item>
                </td>
              </tr>
              <!-- 结果判定 -->
              <tr>
                ...
                <td>
                  <el-form-item :prop="`room5_check_res`" :rules="checkFormRules.room5_check_res">
                    <el-select
                      v-model="checkTableData.room5_check_res"
                      placeholder="请选择"
                      filterable
                    >
                      <el-option
                ...
                <td colspan="2">
                  <el-form-item :prop="`room6_check_res`" :rules="checkFormRules.room6_check_res">
                    <el-select
                      v-model="checkTableData.room6_check_res"
                      placeholder="请选择"
                      filterable
                    >
                      <el-option
