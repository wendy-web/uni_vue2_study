...
<view class="cont-tabs" id="contBox">
	<view class="remind_box fl_center">
		<image class="remind_icon" :src="takeImgUrl + '/starbucks_remind.png'" mode="aspectFill"></image>
		自助点餐，不支持外卖
	</view>
	<scroll-view
		v-if="tabs.length"
	...
	>
		<view class="tabs-item" :style="{ '--padding': isShowComBuy ? '106rpx' : '0rpx' }">
			...
			<view class="tab-item"
				...
				:id="'tabItemId'+i"
			>
				<view class="cont_title">{{ tab.categoryName }}</view>
			...
			<view class="add_label">
				本产品为第三方代点餐服务,即第三方人员代下单服务与星巴克官方无关!
			</view>
		</view>
	</scroll-view>
</view>
