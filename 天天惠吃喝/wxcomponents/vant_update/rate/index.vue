<template>
<uni-shadow-root class="vant_update-rate-index"><view :class="(utils.bem('rate'))+' custom-class'" @touchmove="onTouchMove">
...
global['__wxRoute'] = 'vant_update/rate/index'
...
export default global['__wxComponents']['vant_update/rate/index']
</script>
