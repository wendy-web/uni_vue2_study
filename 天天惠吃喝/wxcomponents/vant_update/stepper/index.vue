<template>
<uni-shadow-root class="vant_update-stepper-index"><view :class="(utils.bem('stepper', [theme]))+' custom-class'">
...
global['__wxRoute'] = 'vant_update/stepper/index'
...
export default global['__wxComponents']['vant_update/stepper/index']
</script>
