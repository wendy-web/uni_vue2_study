<template>
<uni-shadow-root class="vant_update-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = 'vant_update/index-bar/index'
...
export default global['__wxComponents']['vant_update/index-bar/index']
</script>
