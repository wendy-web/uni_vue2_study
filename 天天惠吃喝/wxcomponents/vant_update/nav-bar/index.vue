<template>
<uni-shadow-root class="vant_update-nav-bar-index"><view v-if="fixed && placeholder" :style="'height: '+(height)+'px;'"></view>
...
global['__wxRoute'] = 'vant_update/nav-bar/index'
...
export default global['__wxComponents']['vant_update/nav-bar/index']
</script>
