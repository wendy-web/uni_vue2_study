<template>
<uni-shadow-root class="vant_update-tabs-index"><view :class="'custom-class '+(utils.bem('tabs'))">
...
global['__wxRoute'] = 'vant_update/tabs/index'
...
export default global['__wxComponents']['vant_update/tabs/index']
</script>
