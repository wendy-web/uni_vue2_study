<template>
<uni-shadow-root class="vant_update-radio-index"><view :class="(utils.bem('radio', [direction]))+' custom-class'">
...
global['__wxRoute'] = 'vant_update/radio/index'
...
export default global['__wxComponents']['vant_update/radio/index']
</script>
