<template>
<uni-shadow-root class="Kujiale-Mobile-painter-painter"><canvas canvas-id="k-canvas" :style="(painterStyle)+(customStyle)"></canvas></uni-shadow-root>
</template>
...
export default global['__wxComponents']['Kujiale-Mobile-painter/painter']
</script>
