...
//路由白名单
const whiteList = ['/pages/tabBar/user/index', '/pages/tabBar/home/index', '/pages/user/rankingList/index',
	'/pages/user/strategy/index', '/pages/rankBoard/index', '/pages/user/medal/index'
];
...
function routeDetection(config) {
	return new Promise((resolve, reject) => {
		//登录校验
		let accredit = Boolean(getAuthorization());
