...
export default {
  data() {
    return {
      innerShow: false,
      privacyContractName: '《点亮城市攒能量小程序隐私保护指引》',
      currentPage: '', // 当前页面地址
      disagreePrivacyPageList: [
        'pages/tabBar/home/index',
        'pages/tabBar/user/index',
        'pages/scanModular/index/index',
        'pages/originalScan/scan/scan',
        'pages/love/loveDetails/index'
      ], // 不同意授权页面的判断
    }
  },
  mounted() {
  ...
  methods: {
    ...
    handleDisagree(e) {
      ...
      privacyResolves.forEach(resolve => {
        ...
        if(isBack)  {
          // this.$switchTab('/pages/tabBar/home/index');
        } else {
          resolve({
            event: 'disagree',
          });
