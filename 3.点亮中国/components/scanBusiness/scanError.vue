<template>
	<view class="scan-error-popup">
		<van-popup :show="show"   @close="popupClose" custom-style="background-color: transparent;" :close-on-click-overlay="false" :z-index="10000">
			<view class="scan-error-popup-box">
	               <view class="scan-error-title">
	               	 温馨提示
	               </view>
				   <view class="scan-error-tips">
				   	 {{msg}}
				   </view>
				   <view class="scan-error-icon">
						<van-image  width="502rpx" height="358rpx" src="/static/scan/home_scan_error.png" fit="cover"  use-loading-slot>
