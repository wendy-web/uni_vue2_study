<template>
<uni-shadow-root class="vant_update-toast-index"><van-overlay v-if="mask || forbidClick" :show="show" :z-index="zIndex" :custom-style="mask ? '' : 'background-color: transparent;'"></van-overlay>
...
global['__wxRoute'] = 'vant_update/toast/index'
...
export default global['__wxComponents']['vant_update/toast/index']
</script>
