<template>
<uni-shadow-root class="vant_update-uploader-index"><view class="van-uploader">
...
global['__wxRoute'] = 'vant_update/uploader/index'
...
export default global['__wxComponents']['vant_update/uploader/index']
</script>
