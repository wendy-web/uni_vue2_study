<template>
<uni-shadow-root class="vant_update-notice-bar-index"><view v-if="show" :class="'custom-class '+(utils.bem('notice-bar', { withicon: mode, wrapable }))" :style="computed.rootStyle({ color, backgroundColor, background })" @click="onClick">
...
global['__wxRoute'] = 'vant_update/notice-bar/index'
...
export default global['__wxComponents']['vant_update/notice-bar/index']
</script>
