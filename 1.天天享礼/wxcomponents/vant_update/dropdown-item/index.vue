<template>
<uni-shadow-root class="vant_update-dropdown-item-index"><view v-if="showWrapper" :class="(utils.bem('dropdown-item', direction))+' custom-class'" :style="wrapperStyle">
...
global['__wxRoute'] = 'vant_update/dropdown-item/index'
...
export default global['__wxComponents']['vant_update/dropdown-item/index']
</script>
