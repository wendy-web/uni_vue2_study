<template>
<uni-shadow-root class="vant_update-cascader-index"><view v-if="showHeader" class="van-cascader__header">
...
global['__wxRoute'] = 'vant_update/cascader/index'
...
export default global['__wxComponents']['vant_update/cascader/index']
</script>
