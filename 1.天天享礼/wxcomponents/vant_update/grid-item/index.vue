<template>
<uni-shadow-root class="vant_update-grid-item-index"><view :class="'custom-class '+(utils.bem('grid-item', { square }))" :style="computed.wrapperStyle({ square, gutter, columnNum, index })" @click="onClick">
...
global['__wxRoute'] = 'vant_update/grid-item/index'
...
export default global['__wxComponents']['vant_update/grid-item/index']
</script>
