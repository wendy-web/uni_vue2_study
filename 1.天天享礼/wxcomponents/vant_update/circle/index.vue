<template>
<uni-shadow-root class="vant_update-circle-index"><view class="van-circle">
...
global['__wxRoute'] = 'vant_update/circle/index'
...
export default global['__wxComponents']['vant_update/circle/index']
</script>
