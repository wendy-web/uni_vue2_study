<template>
<uni-shadow-root class="vant_update-goods-action-index"><view :class="'custom-class '+(utils.bem('goods-action', { safe: safeAreaInsetBottom }))">
  <slot></slot>
...
global['__wxRoute'] = 'vant_update/goods-action/index'
...
export default global['__wxComponents']['vant_update/goods-action/index']
</script>
