<template>
<uni-shadow-root class="vant_update-empty-index"><view class="custom-class van-empty">
...
global['__wxRoute'] = 'vant_update/empty/index'
...
export default global['__wxComponents']['vant_update/empty/index']
</script>
