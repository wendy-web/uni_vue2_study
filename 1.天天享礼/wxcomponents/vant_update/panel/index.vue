<template>
<uni-shadow-root class="vant_update-panel-index"><view class="van-panel van-hairline--top-bottom custom-class">
...
global['__wxRoute'] = 'vant_update/panel/index'
...
export default global['__wxComponents']['vant_update/panel/index']
</script>
