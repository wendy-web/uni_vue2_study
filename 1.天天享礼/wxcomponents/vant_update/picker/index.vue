<template>
<uni-shadow-root class="vant_update-picker-index"><view class="van-picker custom-class" :style="'--picker-background-color:'+(backgroundColor)">
...
global['__wxRoute'] = 'vant_update/picker/index'
...
export default global['__wxComponents']['vant_update/picker/index']
</script>
