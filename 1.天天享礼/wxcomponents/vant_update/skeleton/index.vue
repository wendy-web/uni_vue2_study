<template>
<uni-shadow-root class="vant_update-skeleton-index"><view v-if="loading" :class="'custom-class '+(utils.bem('skeleton', [{animate}]))">
...
global['__wxRoute'] = 'vant_update/skeleton/index'
...
export default global['__wxComponents']['vant_update/skeleton/index']
</script>
