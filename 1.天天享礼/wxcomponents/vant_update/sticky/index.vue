<template>
<uni-shadow-root class="vant_update-sticky-index"><view class="custom-class van-sticky" :style="computed.containerStyle({ fixed, height, zIndex })">
...
global['__wxRoute'] = 'vant_update/sticky/index'
...
export default global['__wxComponents']['vant_update/sticky/index']
</script>
