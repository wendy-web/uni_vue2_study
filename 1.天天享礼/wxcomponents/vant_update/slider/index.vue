<template>
<uni-shadow-root class="vant_update-slider-index"><view :class="'custom-class '+(utils.bem('slider', { disabled, vertical }))" :style="wrapperStyle" @click="onClick">
...
global['__wxRoute'] = 'vant_update/slider/index'
...
export default global['__wxComponents']['vant_update/slider/index']
</script>
