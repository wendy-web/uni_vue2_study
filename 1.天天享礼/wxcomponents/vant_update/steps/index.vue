<template>
<uni-shadow-root class="vant_update-steps-index"><view :class="'custom-class '+(utils.bem('steps', [direction]))">
...
global['__wxRoute'] = 'vant_update/steps/index'
...
export default global['__wxComponents']['vant_update/steps/index']
</script>
