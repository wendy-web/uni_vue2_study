<template>
<uni-shadow-root class="vant_update-calendar-components-header-index"><view class="van-calendar__header">
...
global['__wxRoute'] = 'vant_update/calendar/components/header/index'
...
export default global['__wxComponents']['vant_update/calendar/components/header/index']
</script>
