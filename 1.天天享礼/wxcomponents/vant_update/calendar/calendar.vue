<template>
<uni-shadow-root class="vant_update-calendar-calendar"><view class="van-calendar">
...
global['__wxRoute'] = 'vant_update/calendar/calendar'

Component({})

export default global['__wxComponents']['vant_update/calendar/calendar']
</script>
