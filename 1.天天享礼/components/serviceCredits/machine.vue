...
<style lang="scss">
	...
	.machine-box {
		...
		&::before {
			content: '\3000';
			background: url("https://file.y1b.cn/store/1-0/23713/64afec64727fe.png") 0 0 / 100% 100%;
			position: absolute;
			left: 0;
			top: 0;
			width: 100%;
		...
		.machine-body {
			...
			&::before {
				content: '\3000';
				background: url("https://file.y1b.cn/store/1-0/23713/64afec9201366.png") 0 0 / 100% 100%;
				position: absolute;
				left: 0;
				top: 0;
				width: 100%;
