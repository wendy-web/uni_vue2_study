<template>
	<view class="exchange-code">
		<xh-navbar :title="type===1?'换购成功':'订单详情'" titleColor="#000000" titleAlign="titleCenter"
			:leftImage="type===1?'/static/images/home.png':'/static/images/left_black_arrow.png'" :isHome="type===1" />
		<!-- 主体  -->
		<view class="exchange-body" :style="{'padding-top':type === 1?'130rpx' : '0rpx',top:navbarHeight+'px'}">
			...
			<view class="ticket-tank-number">
				...
				<image class="zm-icon" mode="aspectFill" src="../static/zm_icon.png"></image>
			</view>
			<!-- 支付时间 -->
			<view class="pay-time">
			...
			<!-- 背景 -->
			<!-- <image class="ex-zm-bg" src="../static/ex_bg.png" mode="aspectFill"></image> -->
		</view>
		<!-- 二维码核销进度 -->
