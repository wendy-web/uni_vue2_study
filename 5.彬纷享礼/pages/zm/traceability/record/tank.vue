<template>
	<view class="record-tank">
		<!-- 导航 -->
		<xh-navbar navber-color="#EDEDED" left-image="/static/images/left_black_arrow.png" :is-no-occupant="true">
			<block slot="title">
				<view class="record-title">
					扫码记录
				</view>
				<!-- icon -->
				<image class="nav-icon" src="https://file.y1b.cn/public/hn29th/record/icon_02.png" mode="aspectFill" />
			</block>
		</xh-navbar>
