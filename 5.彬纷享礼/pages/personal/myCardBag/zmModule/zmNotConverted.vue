...
<template>
	<view class="zm-not-converted" @click="$emit('setCheckItem',config)">
		...
		<view class="zm-card">
			<!-- 背景 -->
			<image class="zm-card-head" src="/pages/personal/static/warHorse/zm_card_head.png" mode="aspectFill">
			</image>
			<image class="zm-card-body" src="/pages/personal/static/warHorse/zm_card_body.png" mode="aspectFill">
			</image>
			<!-- 卡券名称 -->
			...
			<!-- 倒计时 -->
			<view class="card-expire" v-if="config.open">有效期：<text
