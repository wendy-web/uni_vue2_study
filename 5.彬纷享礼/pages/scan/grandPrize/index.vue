<template>
	<view class="grand-prize">
		<view class="grand-prize-head">
			<image class="grand-prize-banner" src="../static/grand_prize_banner.png" mode="aspectFill"></image>
		</view>
			...
			<view class="grand-prize-form">
				<van-cell-group :border="false">
					...
					<view class="authorized-telephone">
						...
						<button v-if="!cactGetInfo.mobile" class="zm-item-btn" open-type="getPhoneNumber"
	...
	export default {
		...
		data() {
			return {
				...
				// 	name: {
				// 		error: false,
				// 		errorMessage: '请输入合规的用户名'
				// 	},
				// 	id_card: {
				// 		error: false,
				// 		errorMessage: '请输入合规的身份证号码'
				// 	}
				// },
				isNoEdit: false
			}
