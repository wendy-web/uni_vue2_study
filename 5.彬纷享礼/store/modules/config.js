...
const state = {
    ...
    homeIcon: '',
	tradeJump: '',
    newPeople: 0, // 新人身份标识 ： 0 老用户； 1：新用户
};
...
const mutations = {
    ...
    setNewPeople(state, data) {
        if (data) state.newPeople = data
    },
	...
	setTradeJump(state, data) {
	    if (data) state.tradeJump = data
	},
};
