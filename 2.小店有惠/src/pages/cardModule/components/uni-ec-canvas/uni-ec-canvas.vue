...
<view class="canvas_box">
  <canvas type="2d"
    v-if="isUseNewCanvas"
      class="ec-canvas" :canvas-id="canvasId" @init="init" @touchstart="touchStart"
    @touchmove="touchMove" @touchend="touchEnd" :disable-scroll="false">
  </canvas>
  <canvas v-else class="ec-canvas" :canvas-id="canvasId" @init="init" @touchstart="touchStart" @touchmove="touchMove"
    @touchend="touchEnd" :disable-scroll="false">
  </canvas>
  <view class="canvas_bf"></view>
</view>
</template>
