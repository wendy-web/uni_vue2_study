<template>
<uni-shadow-root class="vant_update-transition-index"><view v-if="inited" :class="'van-transition custom-class '+(classes)" :style="computed.rootStyle({ currentDuration, display, customStyle })" @transitionend="onTransitionEnd">
  <slot></slot>
...
global['__wxRoute'] = 'vant_update/transition/index'
...
export default global['__wxComponents']['vant_update/transition/index']
</script>
