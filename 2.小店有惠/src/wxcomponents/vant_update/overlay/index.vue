<template>
<uni-shadow-root class="vant_update-overlay-index"><root-portal v-if="rootPortal">
...
global['__wxRoute'] = 'vant_update/overlay/index'
...
export default global['__wxComponents']['vant_update/overlay/index']
</script>
