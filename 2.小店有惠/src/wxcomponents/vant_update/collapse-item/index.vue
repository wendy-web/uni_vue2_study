<template>
<uni-shadow-root class="vant_update-collapse-item-index"><view :class="'van-collapse-item custom-class '+(index !== 0 ? 'van-hairline--top' : '')">
...
global['__wxRoute'] = 'vant_update/collapse-item/index'
...
export default global['__wxComponents']['vant_update/collapse-item/index']
</script>
