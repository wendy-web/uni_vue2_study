<template>
<uni-shadow-root class="vant_update-popup-index"><van-overlay v-if="overlay" :show="show" :z-index="zIndex" :custom-style="overlayStyle" :duration="duration" @click="onClickOverlay" :lock-scroll="lockScroll" :root-portal="rootPortal"></van-overlay>
...
global['__wxRoute'] = 'vant_update/popup/index'
...
export default global['__wxComponents']['vant_update/popup/index']
</script>
