<template>
<uni-shadow-root class="vant_update-count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = 'vant_update/count-down/index'
...
export default global['__wxComponents']['vant_update/count-down/index']
</script>
