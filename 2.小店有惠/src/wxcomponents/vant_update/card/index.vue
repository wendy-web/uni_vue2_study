<template>
<uni-shadow-root class="vant_update-card-index"><view class="custom-class van-card">
...
global['__wxRoute'] = 'vant_update/card/index'
...
export default global['__wxComponents']['vant_update/card/index']
</script>
