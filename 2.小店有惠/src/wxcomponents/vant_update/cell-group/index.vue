<template>
<uni-shadow-root class="vant_update-cell-group-index"><view v-if="title" :class="utils.bem('cell-group__title', { inset })">
  {{ title }}
</view>
...
global['__wxRoute'] = 'vant_update/cell-group/index'
...
export default global['__wxComponents']['vant_update/cell-group/index']
</script>
