<template>
<uni-shadow-root class="vant_update-checkbox-index"><view :class="(utils.bem('checkbox', [{ horizontal: direction === 'horizontal' }]))+' custom-class'">
...
global['__wxRoute'] = 'vant_update/checkbox/index'
...
export default global['__wxComponents']['vant_update/checkbox/index']
</script>
