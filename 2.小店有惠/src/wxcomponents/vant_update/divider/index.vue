<template>
<uni-shadow-root class="vant_update-divider-index"><view :class="'custom-class '+(utils.bem('divider', [{ dashed, hairline }, contentPosition]))" :style="computed.rootStyle({ borderColor, textColor, fontSize, customStyle })">
  <slot></slot>
...
global['__wxRoute'] = 'vant_update/divider/index'
...
export default global['__wxComponents']['vant_update/divider/index']
</script>
