<template>
<uni-shadow-root class="vant_update-tag-index"><view :class="'custom-class '+(utils.bem('tag', [type, size, { mark, plain, round }]))" :style="computed.rootStyle({ plain, color, textColor })">
  <slot></slot>
...
global['__wxRoute'] = 'vant_update/tag/index'
...
export default global['__wxComponents']['vant_update/tag/index']
</script>
