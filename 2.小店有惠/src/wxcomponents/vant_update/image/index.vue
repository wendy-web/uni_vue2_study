<template>
<uni-shadow-root class="vant_update-image-index"><view :style="computed.rootStyle({ width, height, radius })" :class="'custom-class '+(utils.bem('image', { round }))" @click="onClick">
...
global['__wxRoute'] = 'vant_update/image/index'
...
export default global['__wxComponents']['vant_update/image/index']
</script>
