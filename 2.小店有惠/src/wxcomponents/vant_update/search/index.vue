<template>
<uni-shadow-root class="vant_update-search-index"><view :class="(utils.bem('search', { withaction: showAction || useActionSlot }))+' custom-class'" :style="'background: '+(background)">
...
global['__wxRoute'] = 'vant_update/search/index'
...
export default global['__wxComponents']['vant_update/search/index']
</script>
