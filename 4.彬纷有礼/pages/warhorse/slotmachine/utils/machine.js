...
export default class Machine {
  constructor(pageContext, opts) {
    ...
    this.fanbeiimg = opts.fanbeiimg
    this.jindouimg = opts.jindouimg
    this.ewaiimg = opts.ewaiimg
      ...
      this.timer3 = setTimeout(() => {
        if (i4 <= sRange) {
          ...
          if (Math.abs(transY4) >= endDis4) {
            ...
            console.log("开始回调···this:");
            // this.page.listenerButtonStop();
            // var src = app.globalData.COS_URL + "/public/music/k_2.mp3";
            // this.page.listenerButtonPlay(src);
