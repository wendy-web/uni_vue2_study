// pages/couponActivity/gzUnbox/ranklist/index.js
let app = getApp();
...
import { unboxActInfoGz,rankListGz16} from '../../../../api/shopActivity/index'
...
Page({
  ...
  getRankList: function (param, mask = true) {
    ...
    return new Promise(function (resolve, reject) {
      // rankList14(param, mask).then(res => {
      rankListGz16(param, mask).then(res => {
        let {
          data
        } = res;
  ...
  loadData(event) {
    ...
    rankListGz16(param, true).then(res => {
      let {
        data,
        code
      } = res;
