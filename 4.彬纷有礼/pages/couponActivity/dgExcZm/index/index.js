// pages/couponActivity/dgExcZm/index/index.js
let app = getApp();
...
Page({
  ...
  data: {
    ...
    cos_file_2310:`${COS_URL}/public/img/bfyl/2023/10`,//东莞战马兑奖活动
  },
  ...
  async onReady() {
    try {
      ...
      let navBarHeight = navBarSystem?navBarSystem.navBarHeight+navBarSystem.statusBarHeight:'70'
      this.setData({
        navBarSystem,
        navBarHeight
      })
  ...
  testPop() {
    // this.selectComponent("#storeExchangePop").showExcProcessPop();
    // this.selectComponent("#storeExchangePop").showActNoExcPop();
